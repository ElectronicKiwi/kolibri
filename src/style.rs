...
/// a WidgetStyle specifies custom styling for a Widget
#[derive(Debug, Clone, Copy)]
...
/// a ButtonStyle specifies custom styling for widgets like buttons that have different interaction states
#[derive(Debug, Clone, Copy)]
